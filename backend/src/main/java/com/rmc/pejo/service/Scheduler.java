...
public class Scheduler {
    ...
    public void checkDateTimeReminders() {
        ...
        List<Reminder> activeReminders = reminderRepository.findAllByActive(true);

        activeReminders.forEach(reminder -> {
            LocalDate reminderDate = reminder.getReminderDate();
            LocalTime reminderTime = reminder.getReminderTime();
            boolean isTheSameDay = today.datesUntil(reminderDate).toList().isEmpty();
            boolean isNow = now.until(reminderTime, SECONDS) < ONE_SECOND;

            if (isTheSameDay && isNow) {
                reminder.setActive(false);
                reminderRepository.save(reminder);
                emailSender.send(owner, buildEmail(name, reminder), reminder.getTitle());
            }
        });
    }

    private String buildEmail(String name, Reminder reminder) {
//        TODO: Improve mail formatting
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                ...
                "color:#0b0c0c\"> " + reminder.getDescription() + " </p></blockquote>\n " +
                "      </td>\n" +
                "      <td width=\"10\" valign=\"middle\"><br></td>\n" +
                "    </tr>\n" +
                "    <tr>\n" +
